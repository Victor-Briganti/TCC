...
Para avaliar a perda de acurácia das aplicações, foram adotadas três métricas distintas: o \gls{mape}, o \gls{mcr} e o \gls{ssim}, definidos, respectivamente, nas Equações~\autoref{eq:smape}, \autoref{eq:mcr} e \autoref{eq:ssim}.
