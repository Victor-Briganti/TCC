...
\sigla{cp}{CP}{Computação Paralela}
\sigla{gpu}{GPU}{\textit{Graphics Processing Unit}}
\sigla{hpc}{HPC}{\textit{High-Performance Computing}}
\sigla{iir}{IIR}{\textit{Infinite Impulse Response}}
\sigla{mcr}{MCR}{\textit{Miss-Classification Rate}}
\sigla{simd}{SIMD}{\textit{Single Instruction Multiple Data}}
\sigla{smape}{SMAPE}{\textit{Symmetric Mean Absolute Percentage Error}}
\sigla{ssim}{SSIM}{\textit{Structural Similarity Index Measure}}

%% LEIA:

%% Para usar o \gls, você deve colocar a sigla aqui em \siglas
