...
\evalboardmember{João Fabrício Filho}{Doutorado}{Universidade Tecnológica Federal do Paraná}
\evalboardmember{Rogério Aparecido Gonçalves}{Doutorado}{Universidade Tecnológica Federal do Paraná}
\evalboardmember{Juliano Henrique Foleiss}{Doutorado}{Universidade Tecnológica Federal do Paraná}
\evalboardmember{Lucas Francisco Wanner}{Doutorado}{Universidade Estadual de Campinas}
...
\PalavraChaveD{anota\c{c}\~oes de c\'odigo}
\PalavraChaveE{computa\c{c}\~ao aproximada}
...
\KeywordA{parallelism}%% Palavra-chave A
\KeywordB{LLVM}%% Palavra-chave B
\KeywordC{high performance}%% Palavra-chave C
\KeywordD{code annotations}%% Palavra-chave D
\KeywordE{approximate computing}%% Palavra-chave E
