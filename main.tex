...
% Deixando o texto das referências justificado
\PassOptionsToPackage{alf,bibjustif}{abntex2cite}
...
\lstset{
    ...
    linewidth=\dimexpr\linewidth-2em\relax
}
...
% Renomeia Listagem para Código
\renewcommand{\sourcecodename}{Código}

% Altera seção para letra maiúscula.
...
\include{capitulos/cap02-fundamentacao_teorica}
\include{capitulos/cap03-proposta}
\include{capitulos/cap04-metodologia}
\include{capitulos/cap05-resultados}
